...
class test_suit_phone_case1(TestCaseBase):
    '''
    test_suit_phone_case1 is a class for phone case.
    ...
    def test_case_main(self, case_results):
        ...
        for i in range(0,call_repeat_times):
            ...
            #call
            #make sure whether get though
            phoneOn = phone.phone_call(phoneNumber, "", 0)
...
def pre_settings():
    ...
    '''
    if test_suit_phone.BOOL_STK_VOCIE_CALL_CHECK == False:
        #switch voice call to always ask
        #remove guide info when enter first time
        phone.set_data_call(0)

        test_suit_phone.BOOL_STK_VOCIE_CALL_CHECK = True