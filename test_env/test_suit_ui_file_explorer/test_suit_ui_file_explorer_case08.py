...
#function:
#    copy and paste items cross storage
#precondition:
#    
#step:
#    1.goto FileExplorer; 
...
class test_suit_ui_file_explorer_case08(TestCaseBase):
    tag = 'ui_file_explorer_case08'
    ...
    def test_case_main(self, case_results):
        ...
        if case_flag:
            ...
            qsst_log_case_status(STATUS_FAILED, "copy and paste items cross storage is failed", SEVERITY_HIGH)
