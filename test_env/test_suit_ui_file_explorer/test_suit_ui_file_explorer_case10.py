...
#function:
#    launch music and share in FileExplorer
#precondition:
#    anot
#step:
#    1.goto FileExplorer; 
...
class test_suit_ui_file_explorer_case10(TestCaseBase):
    tag = 'ui_file_explorer_case10'
    ...
    def test_case_main(self, case_results):
        ...
        if case_flag:
            ...
            qsst_log_case_status(STATUS_FAILED, "launch music and share is failed", SEVERITY_HIGH)
