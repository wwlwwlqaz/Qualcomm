...
class test_suit_ui_file_explorer_case12(TestCaseBase):
    tag = 'ui_file_explorer_case12'
    ...
    def test_case_main(self, case_results):
        ...
        if case_flag:
            ...
            qsst_log_case_status(STATUS_FAILED, "launch image and share is failed", SEVERITY_HIGH)
