...
class test_suit_cmcc_devci_settings_case13(TestCaseBase):
    '''
...
#             phone.permission_allow()                  
        settings.check_cellular_networks()
        if wait_for_fun(lambda:search_text("Preferred network type"), True, 5):
            log_test_framework("cmcc_devci_settings_case13:", "case pass")
            case_flag = True
        elif search_text("stopped", searchFlag=TEXT_CONTAINS):
            log_test_framework("cmcc_devci_settings_case13:", "Popup has stopped")
            take_screenshot()
            if search_text("OK"):
            ...
            log_test_framework("cmcc_devci_settings_case13:", "case fail")        
