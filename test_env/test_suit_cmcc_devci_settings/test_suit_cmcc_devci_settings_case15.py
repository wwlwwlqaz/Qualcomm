...
class test_suit_cmcc_devci_settings_case15(TestCaseBase):
    '''
...
#             phone.permission_allow()                  
        settings.set_APN_protocol()
        if wait_for_fun(lambda:search_text("IPv4"), True, 5):
            log_test_framework("cmcc_devci_settings_case15:", "case pass")
            case_flag = True
        elif search_text("stopped", searchFlag=TEXT_CONTAINS):
            log_test_framework("cmcc_devci_settings_case15:", "Popup has stopped")
            take_screenshot()
            if search_text("OK"):
            ...
            log_test_framework("cmcc_devci_settings_case15:", "case fail")        
