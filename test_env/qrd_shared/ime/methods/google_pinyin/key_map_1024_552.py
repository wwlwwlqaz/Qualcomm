...
key_map['ch_en'] = (key_map['q'][0],q_y + gap_y * 3)
#switch key in character and number
key_map['num_sign'] = (key_map['x'][0],q_y + gap_y * 3)
#blank space
key_map[' '] = (key_map['v'][0],q_y + gap_y * 3)
#full stop or apostrophe
key_map['.'] = (key_map['n'][0],q_y + gap_y * 3)
#next or complete
key_map['next'] = (key_map['p'][0],q_y + gap_y * 3)
...
#key:@ or ©
key_map['sign_1'] = (key_map['1'][0],q_y + gap_y)
#key:# or £
key_map['sign_2'] = (key_map['2'][0],q_y + gap_y)
#key:$ or €
key_map['sign_3'] = (key_map['3'][0],q_y + gap_y)
#key:% or ^
key_map['sign_4'] = (key_map['4'][0],q_y + gap_y)
#key:" or ®
key_map['sign_5'] = (key_map['5'][0],q_y + gap_y)
#key:* or °F
key_map['sign_6'] = (key_map['6'][0],q_y + gap_y)
#key:- or _
key_map['sign_7'] = (key_map['7'][0],q_y + gap_y)
#key:/ or =
key_map['sign_8'] = (key_map['8'][0],q_y + gap_y)
#key:( or [
key_map['sign_9'] = (key_map['9'][0],q_y + gap_y)
#key:) or ]
key_map['sign_10'] = (key_map['0'][0],q_y + gap_y)
#key:! or ™
...
#key:: or +
key_map['sign_14'] = (key_map['v'][0],q_y + gap_y*2)
#key:; or |
