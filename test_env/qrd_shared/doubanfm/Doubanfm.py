'''
   shared library of doubanfm module.

   This class will provide operations api for doubanfm application.
...
class Doubanfm(Base):
    '''
    Doubanfm is a class for operating doubanfm application.
