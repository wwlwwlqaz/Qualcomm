...
class test_suit_ui_browser_case04(TestCaseBase):
    '''
    test_suit_ui_browser_case04 is a class for playing online streaming - music

    @see: L{TestCaseBase <TestCaseBase>}
    '''
    tag = 'ui_browser_case04'
    def test_case_main(self, case_results):
        ...
        browser.access_browser(URL_TITLE['百度音乐'][0], '百度音乐', 5, is_checked=False)
        take_screenshot()
        # click(POSITION['video'][0],POSITION['video'][1])
        # click(431.0 * width_rate, 1187 * height_rate)  # choose album
        click(225 * width_rate, 1072 * height_rate)
        sleep(10)
        take_screenshot()
        # click(257*width_rate,768*height_rate)  # click 'play'
        sleep(30)
        take_screenshot()
        click(864 * width_rate, 1856 * height_rate)  # stop play music
        sleep(2)
        take_screenshot()
