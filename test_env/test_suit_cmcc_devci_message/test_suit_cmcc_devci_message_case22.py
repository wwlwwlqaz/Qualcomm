...
class test_suit_cmcc_devci_message_case22(TestCaseBase):
    '''
...
#         settings.set_default_sms(1)
        ...
        if search_view_by_id("action_compose_new") or search_view_by_id("create"):
            ...
            sleep(1)
        mms.send_sms("13916371096","hi139")
        if wait_for_fun(lambda:search_text("Now"), True, 120):
                log_test_case(self.case_config_map[fs_wrapper.CASE_NAME_ATTR], "send from SIM1 succussfully")
                case_flag=True       
