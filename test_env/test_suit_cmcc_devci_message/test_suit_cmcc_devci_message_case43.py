...
class test_suit_cmcc_devci_message_case43(TestCaseBase):
    '''
...
#             phone.permission_allow()
        ...
        if wait_for_fun(lambda:search_text("Message details", searchFlag=TEXT_CONTAINS), True, 6):
            log_test_case(self.case_config_map[fs_wrapper.CASE_NAME_ATTR], "Check message detail of SMS successfully")
            case_flag=True                  
