...
class test_suit_stress_test_camera1_case000024(TestCaseBase):
    '''
    ...
    "Procedure:
    Step1:Launch Camera;
    Step2:Start recording video sleep 1s then stop recording;
    ...
    def test_case_main(self, case_results):
        ...
        if wait_for_fun(lambda:search_view_by_id('shutter_button'), True, 5):
            ...
            for i in range(iterationNum):
                ...
                success_flag = False
                camera.take_video_camera1(1)           
                if wait_for_fun(lambda:search_view_by_id('shutter_button'), True, 5):
                    log_test_framework("step2:", "Start recording video sleep 1s then stop recording pass")
                    success_flag = True        
