...
class test_suit_stress_test_camera1_case000006(TestCaseBase):
    '''
    ...
    Step3:Switch to camera to take a picture;
        ...
        if wait_for_fun(lambda:search_view_by_id('front_back_switcher'), True, 5):
            ...
            for i in range(iterationNum):
                ...
                if wait_for_fun(lambda:search_view_by_id('shutter_button'), True, 8):
                    log_test_framework("step2:", "Switch to Video Record use front camera pass")
                    record_flag = True
                    if wait_for_fun(lambda:search_view_by_id('camera_switcher'), True, 5):
                        click_imageview_by_id("camera_switcher")
                    ...
                    if wait_for_fun(lambda:search_view_by_id("shutter_button"), True, 5):                    
                        camera.take_picture()
                        log_test_framework("step3:", "Switch to camera to take a picture pass")
                        picture_flag = True
