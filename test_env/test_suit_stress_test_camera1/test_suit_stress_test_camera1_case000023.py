...
class test_suit_stress_test_camera1_case000023(TestCaseBase):
    '''
    ...
    Step4:tap different effect to repeat for  slide 50 time, such as: None/Punch/Vintage/B/W and so;
