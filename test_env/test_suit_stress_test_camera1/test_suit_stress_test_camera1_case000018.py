...
class test_suit_stress_test_camera1_case000018(TestCaseBase):
    '''
    ...
    "Procedure:
    Step1:Launch Camera;
    Step2:press home, re-launch camera by press recent app;
    ...
    def test_case_main(self, case_results):
        ...
        if wait_for_fun(lambda:search_view_by_id('shutter_button'), True, 5):
            ...
            for i in range(iterationNum):
                ...
                if wait_for_fun(lambda:search_text('Snapdragon Camera'), True, 5):            
                    click_textview_by_text('Snapdragon Camera') 
