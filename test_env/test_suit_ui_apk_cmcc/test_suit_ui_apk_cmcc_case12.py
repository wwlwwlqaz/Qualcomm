...
import shutil
import copy
import test_suit_ui_apk_cmcc_case11

class test_suit_ui_apk_cmcc_case12(TestCaseBase):
    '''
    test_suit_ui_apk_cmcc_case12 is a class for App install case.

    @see: L{TestCaseBase <TestCaseBase>}
    '''
    tag = 'ui_apk_cmcc_case12'
    category = 'SOCIAL'
    
    def test_case_main(self, case_results):
        #call("test_suit_ui_apk_cmcc", "test_suit_ui_apk_cmcc_case11")
        #test_suit_ui_apk_cmcc_case11.test_suit_ui_apk_cmcc_case11.test_case_main()
        '''
        main entry.
