...
class test_suit_ui_apk_cmcc_case11(TestCaseBase):
    '''
    test_suit_ui_apk_cmcc_case11 is a class for APK install,launch,exit,uninstall case.

    @see: L{TestCaseBase <TestCaseBase>}
    '''
    tag = 'ui_apk_cmcc_case11'
    category = 'TOOL'
