...
class test_suit_cmcc_devci_contact_case3(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        contact.add_full_contact_to_phone("full","13816581556","full@163.com","shanghai","qualcomm")
        sleep(3)
        if search_text("full",searchFlag=TEXT_CONTAINS):
            log_test_framework(self.name, "Now add new contact with full information pass")
            case_flag = True
