...
class test_suit_cmcc_devci_contact_case21(TestCaseBase):
    '''
...
#             phone.permission_allow() 
        ...
        contact.add_contact_to_sim1("SIM1","18321456161")
        sleep(3)
        if search_text("SIM1"):
            log_test_framework(self.name, "Create contact on SIM1 successfully")
            case_flag = True
