...
class test_suit_cmcc_devci_contact_case29(TestCaseBase):
    '''
...
#             phone.permission_allow() 
        ...
        sleep(3)    
        contact.add_contact_to_phone("search","185")
        sleep(3)
        click_textview_by_id('menu_search')
        sleep(3)
        click_textview_by_text('Find contacts')
        sleep(3)
        entertext_edittext_on_focused('search')
        sleep(5)        
        if search_text("No contacts") == False:
