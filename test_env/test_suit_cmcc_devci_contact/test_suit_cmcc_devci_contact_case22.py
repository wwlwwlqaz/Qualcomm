...
class test_suit_cmcc_devci_contact_case22(TestCaseBase):
    '''
...
#             phone.permission_allow() 
        if wait_for_fun(lambda:search_text("Contacts", searchFlag=TEXT_CONTAINS), True, 5) or search_text("All contacts") or search_text("ADD NEW ACCOUNT"):
            ...
            sleep(3)
        contact.add_contact_to_phone("sim2","18321212556")    
        contact.copy_contact_to_sim2('sim2')        
        contact.del_one_contact("sim2")
        if search_text("sim2"):
