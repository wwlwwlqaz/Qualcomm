...
class test_suit_cmcc_devci_contact_case18(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        if search_text("Contacts", searchFlag=TEXT_CONTAINS):
        ...
        sleep(3)
        contact.add_contact_to_phone("copy","187")
        if search_text("p") or search_text("copy"):
            log_test_framework(self.name, "Create contact on phone successfully")
            case_flag = True
