...
class test_suit_cmcc_devci_contact_case10(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        contact.add_contact_to_phone("aaa","19721469139")
        sleep(3)
        contact.search_and_delete("aaa")
        if search_text("aaa",searchFlag=TEXT_CONTAINS)==False:
            case_flag = True
