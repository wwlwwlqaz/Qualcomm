...
class test_suit_cmcc_devci_contact_case8(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        '''
        @ we found these field can jump to another activity via intent
        @ phone : it will jump to dail app
        @ mail: it will jump to mail app
        @ Address: it will jump to browser app ,and its url is google map
        '''
        ...
        contact.add_contact_to_phone("details","18651516666")
        if search_text("details", searchFlag=TEXT_CONTAINS):
