...
class test_suit_cmcc_devci_contact_case11(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        contact.add_contact_to_phone("scte","19721469145")
        sleep(3)
        contact.export_contact_to_sim1()
        sleep(3)
        contact.del_one_contact("scte")
        sleep(10)
        if search_text("scte"):
            log_test_framework(self.name, "Export contact to sim1 successfully")
            case_flag=True
            sleep(2)                   
